...
const posts = [
{
  img: "resized_futurewwp.PNG",
  title: "Genexus 18 .NET Web Application",
  desc: "A robust enterprise-grade web application built with Genexus 18 and .NET, designed to automate workflows, simplify processes, and deliver reliable performance for real business operations.",
  url: "",
},
{
  img: "resized_SingAppDash.PNG",
  title: "React TypeScript Admin Dashboard",
  desc: "A modern, scalable admin dashboard developed with React and TypeScript. It centralizes key business metrics, provides secure user access, and enables efficient management of operational data.",
  url: "",
},
{
  img: "resized_SingAppMaster.PNG",
  title: "Simple Data Master",
  desc: "A streamlined data management tool designed to organize, edit, and visualize essential business records. Fast, intuitive, and ideal for teams needing a clean and dependable interface.",
  url: "",
}
];
...
We’d like to share some examples of our work — real systems built with modern, reliable technologies, always tailored to the needs of our clients. At AndradeCodes, every project is an opportunity to transform ideas into powerful, scalable tools. We’re ready to help your ideas take off.
            </Typography>
          </div>
